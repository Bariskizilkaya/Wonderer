...
foreach(_expectedTarget dynamorio dynamorio_static drinjectlib drdecode drlibc drmemfuncs drconfiglib drfrontendlib minizip drmemtrace_reuse_distance drmemtrace_histogram drmemtrace_reuse_time drmemtrace_basic_counts drmemtrace_opcode_mix drmemtrace_syscall_mix drmemtrace_view drmemtrace_func_view drmemtrace_invariant_checker drmemtrace_schedule_stats drmemtrace_schedule_file drmemtrace_mutex_dbg_owned drmemtrace_simulator drmemtrace_record_filter directory_iterator drmemtrace_raw2trace drmemtrace_analyzer drmemtrace_empty empty_creator drcontainers drcontainers_drstatic drmgr drmgr_static drmgr_drstatic drx drx_static drx_drstatic drwrap drwrap_static drwrap_drstatic drreg drreg_static drreg_drstatic drbbdup drbbdup_static drbbdup_drstatic elf_pic dw_pic dwelf_pic ebl_pic drsyms drsyms_static drsyms_drstatic drutil drutil_static drutil_drstatic drcovlib drcovlib_static drcovlib_drstatic drstatecmp drstatecmp_static drstatecmp_drstatic drcallstack drcallstack_static drcallstack_drstatic)
...
set_target_properties(drmemtrace_raw2trace PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio;directory_iterator;drfrontendlib;drmemtrace_schedule_file;drutil_static;/usr/lib32/libpthread.so;/usr/lib/i386-linux-gnu/libz.so;minizip"
)
...
set_target_properties(drmemtrace_analyzer PROPERTIES
  INTERFACE_LINK_LIBRARIES "directory_iterator;drmemtrace_mutex_dbg_owned;/usr/lib32/libpthread.so;/usr/lib/i386-linux-gnu/libz.so;minizip"
)
...
set_target_properties(dw_pic PROPERTIES
  INTERFACE_LINK_LIBRARIES "/usr/lib32/libpthread.so"
)
...
set_target_properties(drsyms_static PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio;dw_pic;dwelf_pic;elf_pic;ebl_pic;/usr/lib/i386-linux-gnu/libz.so;drcontainers;elftc"
)
...
set_target_properties(drsyms_drstatic PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio_static;dw_pic;dwelf_pic;elf_pic;ebl_pic;/usr/lib/i386-linux-gnu/libz.a;drcontainers_drstatic;elftc"
)
