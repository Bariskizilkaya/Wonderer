...
foreach(_expectedTarget dynamorio dynamorio_static drinjectlib drdecode drlibc drmemfuncs drconfiglib drfrontendlib minizip drmemtrace_reuse_distance drmemtrace_histogram drmemtrace_reuse_time drmemtrace_basic_counts drmemtrace_opcode_mix drmemtrace_syscall_mix drmemtrace_view drmemtrace_func_view drmemtrace_invariant_checker drmemtrace_schedule_stats drmemtrace_schedule_file drmemtrace_mutex_dbg_owned drmemtrace_simulator drmemtrace_record_filter directory_iterator ipt pevent ipt-sb drpt2ir drir2trace drmemtrace_raw2trace drmemtrace_analyzer drmemtrace_empty empty_creator drcontainers drcontainers_drstatic drmgr drmgr_static drmgr_drstatic drx drx_static drx_drstatic drwrap drwrap_static drwrap_drstatic drreg drreg_static drreg_drstatic drbbdup drbbdup_static drbbdup_drstatic elf_pic dw_pic dwelf_pic ebl_pic drsyms drsyms_static drsyms_drstatic drutil drutil_static drutil_drstatic drcovlib drcovlib_static drcovlib_drstatic drstatecmp drstatecmp_static drstatecmp_drstatic drpttracer drpttracer_static drpttracer_drstatic drcallstack drcallstack_static drcallstack_drstatic)
...
set_target_properties(drmemtrace_invariant_checker PROPERTIES
  INTERFACE_LINK_LIBRARIES "drdecode;drmemtrace_schedule_file;dynamorio"
)

# Create imported target drmemtrace_schedule_stats
add_library(drmemtrace_schedule_stats STATIC IMPORTED)

# Create imported target drmemtrace_schedule_file
add_library(drmemtrace_schedule_file STATIC IMPORTED)

# Create imported target drmemtrace_mutex_dbg_owned
add_library(drmemtrace_mutex_dbg_owned STATIC IMPORTED)
...
set_target_properties(drmemtrace_record_filter PROPERTIES
  INTERFACE_LINK_LIBRARIES "drmemtrace_simulator;drmemtrace_schedule_file;dynamorio"
)
...
set_target_properties(drmemtrace_raw2trace PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio;directory_iterator;drfrontendlib;drmemtrace_schedule_file;drutil_static;/usr/lib/x86_64-linux-gnu/libpthread.so;snappy;lz4;drpt2ir;drir2trace;/usr/lib/x86_64-linux-gnu/libz.so;minizip"
)
...
set_target_properties(drmemtrace_analyzer PROPERTIES
  INTERFACE_LINK_LIBRARIES "directory_iterator;drmemtrace_mutex_dbg_owned;snappy;lz4;/usr/lib/x86_64-linux-gnu/libpthread.so;/usr/lib/x86_64-linux-gnu/libz.so;minizip"
)

# Create imported target drmemtrace_empty
add_library(drmemtrace_empty STATIC IMPORTED)

# Create imported target empty_creator
add_library(empty_creator SHARED IMPORTED)

set_target_properties(empty_creator PROPERTIES
  INTERFACE_LINK_LIBRARIES "drmemtrace_empty"
)
...
# Create imported target drmgr_drstatic
add_library(drmgr_drstatic STATIC IMPORTED)

set_target_properties(drmgr_drstatic PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio_static;drcontainers_drstatic"
)
...
# Create imported target drx_drstatic
add_library(drx_drstatic STATIC IMPORTED)

set_target_properties(drx_drstatic PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio_static;drcontainers_drstatic;drmgr_drstatic;drreg_drstatic"
)
...
# Create imported target drwrap_drstatic
add_library(drwrap_drstatic STATIC IMPORTED)

set_target_properties(drwrap_drstatic PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio_static;drmgr_drstatic;drcontainers_drstatic"
)
...
# Create imported target drreg_drstatic
add_library(drreg_drstatic STATIC IMPORTED)

set_target_properties(drreg_drstatic PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio_static;drcontainers_drstatic;drmgr_drstatic"
)
...
# Create imported target drbbdup_drstatic
add_library(drbbdup_drstatic STATIC IMPORTED)

set_target_properties(drbbdup_drstatic PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio_static;drcontainers_drstatic;drmgr_drstatic;drreg_drstatic"
)

# Create imported target elf_pic
add_library(elf_pic STATIC IMPORTED)

# Create imported target dw_pic
add_library(dw_pic STATIC IMPORTED)

set_target_properties(dw_pic PROPERTIES
  INTERFACE_LINK_LIBRARIES "/usr/lib/x86_64-linux-gnu/libpthread.so"
)

# Create imported target dwelf_pic
add_library(dwelf_pic STATIC IMPORTED)

# Create imported target ebl_pic
add_library(ebl_pic STATIC IMPORTED)
...
set_target_properties(drsyms_static PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio;dw_pic;dwelf_pic;elf_pic;ebl_pic;/usr/lib/x86_64-linux-gnu/libz.so;drcontainers;elftc"
)

# Create imported target drsyms_drstatic
add_library(drsyms_drstatic STATIC IMPORTED)

set_target_properties(drsyms_drstatic PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio_static;dw_pic;dwelf_pic;elf_pic;ebl_pic;/usr/lib/x86_64-linux-gnu/libz.a;drcontainers_drstatic;elftc"
)
...
# Create imported target drutil_drstatic
add_library(drutil_drstatic STATIC IMPORTED)

set_target_properties(drutil_drstatic PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio_static;drmgr_drstatic"
)
...
# Create imported target drcovlib_drstatic
add_library(drcovlib_drstatic STATIC IMPORTED)

set_target_properties(drcovlib_drstatic PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio_static;drcontainers_drstatic;drmgr_drstatic;drx_drstatic"
)
...
# Create imported target drstatecmp_drstatic
add_library(drstatecmp_drstatic STATIC IMPORTED)

set_target_properties(drstatecmp_drstatic PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio_static;drmgr_drstatic;drreg_drstatic"
)
...
# Create imported target drpttracer_drstatic
add_library(drpttracer_drstatic STATIC IMPORTED)
...
# Create imported target drcallstack_drstatic
add_library(drcallstack_drstatic STATIC IMPORTED)

set_target_properties(drcallstack_drstatic PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio_static;unwind"
)
...
SET_PROPERTY(TARGET drmemtrace_schedule_stats PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drmemtrace_schedule_stats PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)

SET_PROPERTY(TARGET drmemtrace_schedule_file PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drmemtrace_schedule_file PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)

SET_PROPERTY(TARGET drmemtrace_mutex_dbg_owned PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drmemtrace_mutex_dbg_owned PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
...
SET_PROPERTY(TARGET drcontainers_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drcontainers_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
...
SET_PROPERTY(TARGET drmgr_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drmgr_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
...
SET_PROPERTY(TARGET drx_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drx_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
...
SET_PROPERTY(TARGET drwrap_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drwrap_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
...
SET_PROPERTY(TARGET drreg_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drreg_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
...
SET_PROPERTY(TARGET drbbdup_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drbbdup_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)

SET_PROPERTY(TARGET elf_pic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET elf_pic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)

SET_PROPERTY(TARGET dw_pic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET dw_pic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)

SET_PROPERTY(TARGET dwelf_pic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET dwelf_pic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)

SET_PROPERTY(TARGET ebl_pic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET ebl_pic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
...
SET_PROPERTY(TARGET drsyms_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drsyms_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
...
SET_PROPERTY(TARGET drutil_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drutil_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
...
SET_PROPERTY(TARGET drcovlib_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drcovlib_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
...
SET_PROPERTY(TARGET drstatecmp_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drstatecmp_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
...
SET_PROPERTY(TARGET drpttracer_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drpttracer_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
...
SET_PROPERTY(TARGET drcallstack_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drcallstack_drstatic PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
