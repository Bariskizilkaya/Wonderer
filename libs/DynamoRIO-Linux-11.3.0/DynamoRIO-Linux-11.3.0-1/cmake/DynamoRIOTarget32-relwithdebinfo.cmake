...
set_target_properties(minizip PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/tools/lib32/release/libminizip.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS minizip )
list(APPEND _IMPORT_CHECK_FILES_FOR_minizip "${_IMPORT_PREFIX}/tools/lib32/release/libminizip.a" )
...
set_target_properties(drmemtrace_syscall_mix PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_syscall_mix.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drmemtrace_syscall_mix )
list(APPEND _IMPORT_CHECK_FILES_FOR_drmemtrace_syscall_mix "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_syscall_mix.a" )
...
set_target_properties(drmemtrace_invariant_checker PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_invariant_checker.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drmemtrace_invariant_checker )
list(APPEND _IMPORT_CHECK_FILES_FOR_drmemtrace_invariant_checker "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_invariant_checker.a" )
...
set_target_properties(drmemtrace_schedule_stats PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_schedule_stats.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drmemtrace_schedule_stats )
list(APPEND _IMPORT_CHECK_FILES_FOR_drmemtrace_schedule_stats "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_schedule_stats.a" )
...
set_target_properties(drmemtrace_schedule_file PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_schedule_file.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drmemtrace_schedule_file )
list(APPEND _IMPORT_CHECK_FILES_FOR_drmemtrace_schedule_file "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_schedule_file.a" )

# Import target "drmemtrace_mutex_dbg_owned" for configuration "RelWithDebInfo"
set_property(TARGET drmemtrace_mutex_dbg_owned APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drmemtrace_mutex_dbg_owned PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_mutex_dbg_owned.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drmemtrace_mutex_dbg_owned )
list(APPEND _IMPORT_CHECK_FILES_FOR_drmemtrace_mutex_dbg_owned "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_mutex_dbg_owned.a" )
...
set_target_properties(drmemtrace_record_filter PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_record_filter.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drmemtrace_record_filter )
list(APPEND _IMPORT_CHECK_FILES_FOR_drmemtrace_record_filter "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_record_filter.a" )
...
set_target_properties(drmemtrace_empty PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_empty.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drmemtrace_empty )
list(APPEND _IMPORT_CHECK_FILES_FOR_drmemtrace_empty "${_IMPORT_PREFIX}/tools/lib32/release/libdrmemtrace_empty.a" )
...
set_target_properties(empty_creator PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/tools/lib32/release/libempty_creator.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libempty_creator.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS empty_creator )
list(APPEND _IMPORT_CHECK_FILES_FOR_empty_creator "${_IMPORT_PREFIX}/tools/lib32/release/libempty_creator.so" )
...
# Import target "drcontainers_drstatic" for configuration "RelWithDebInfo"
set_property(TARGET drcontainers_drstatic APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drcontainers_drstatic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdrcontainers_drstatic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drcontainers_drstatic )
list(APPEND _IMPORT_CHECK_FILES_FOR_drcontainers_drstatic "${_IMPORT_PREFIX}/ext/lib32/release/libdrcontainers_drstatic.a" )
...
# Import target "drmgr_drstatic" for configuration "RelWithDebInfo"
set_property(TARGET drmgr_drstatic APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drmgr_drstatic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdrmgr_drstatic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drmgr_drstatic )
list(APPEND _IMPORT_CHECK_FILES_FOR_drmgr_drstatic "${_IMPORT_PREFIX}/ext/lib32/release/libdrmgr_drstatic.a" )
...
# Import target "drx_drstatic" for configuration "RelWithDebInfo"
set_property(TARGET drx_drstatic APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drx_drstatic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdrx_drstatic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drx_drstatic )
list(APPEND _IMPORT_CHECK_FILES_FOR_drx_drstatic "${_IMPORT_PREFIX}/ext/lib32/release/libdrx_drstatic.a" )
...
# Import target "drwrap_drstatic" for configuration "RelWithDebInfo"
set_property(TARGET drwrap_drstatic APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drwrap_drstatic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "ASM;C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdrwrap_drstatic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drwrap_drstatic )
list(APPEND _IMPORT_CHECK_FILES_FOR_drwrap_drstatic "${_IMPORT_PREFIX}/ext/lib32/release/libdrwrap_drstatic.a" )
...
# Import target "drreg_drstatic" for configuration "RelWithDebInfo"
set_property(TARGET drreg_drstatic APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drreg_drstatic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdrreg_drstatic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drreg_drstatic )
list(APPEND _IMPORT_CHECK_FILES_FOR_drreg_drstatic "${_IMPORT_PREFIX}/ext/lib32/release/libdrreg_drstatic.a" )
...
# Import target "drbbdup_drstatic" for configuration "RelWithDebInfo"
set_property(TARGET drbbdup_drstatic APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drbbdup_drstatic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdrbbdup_drstatic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drbbdup_drstatic )
list(APPEND _IMPORT_CHECK_FILES_FOR_drbbdup_drstatic "${_IMPORT_PREFIX}/ext/lib32/release/libdrbbdup_drstatic.a" )
...
set_target_properties(elf_pic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libelf_pic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS elf_pic )
list(APPEND _IMPORT_CHECK_FILES_FOR_elf_pic "${_IMPORT_PREFIX}/ext/lib32/release/libelf_pic.a" )
...
set_target_properties(dw_pic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdw_pic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS dw_pic )
list(APPEND _IMPORT_CHECK_FILES_FOR_dw_pic "${_IMPORT_PREFIX}/ext/lib32/release/libdw_pic.a" )
...
set_target_properties(dwelf_pic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdwelf_pic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS dwelf_pic )
list(APPEND _IMPORT_CHECK_FILES_FOR_dwelf_pic "${_IMPORT_PREFIX}/ext/lib32/release/libdwelf_pic.a" )
...
set_target_properties(ebl_pic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libebl_pic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS ebl_pic )
list(APPEND _IMPORT_CHECK_FILES_FOR_ebl_pic "${_IMPORT_PREFIX}/ext/lib32/release/libebl_pic.a" )
...
# Import target "drsyms_drstatic" for configuration "RelWithDebInfo"
set_property(TARGET drsyms_drstatic APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drsyms_drstatic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C;CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdrsyms_drstatic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsyms_drstatic )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsyms_drstatic "${_IMPORT_PREFIX}/ext/lib32/release/libdrsyms_drstatic.a" )
...
# Import target "drutil_drstatic" for configuration "RelWithDebInfo"
set_property(TARGET drutil_drstatic APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drutil_drstatic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdrutil_drstatic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drutil_drstatic )
list(APPEND _IMPORT_CHECK_FILES_FOR_drutil_drstatic "${_IMPORT_PREFIX}/ext/lib32/release/libdrutil_drstatic.a" )
...
# Import target "drcovlib_drstatic" for configuration "RelWithDebInfo"
set_property(TARGET drcovlib_drstatic APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drcovlib_drstatic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdrcovlib_drstatic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drcovlib_drstatic )
list(APPEND _IMPORT_CHECK_FILES_FOR_drcovlib_drstatic "${_IMPORT_PREFIX}/ext/lib32/release/libdrcovlib_drstatic.a" )
...
# Import target "drstatecmp_drstatic" for configuration "RelWithDebInfo"
set_property(TARGET drstatecmp_drstatic APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drstatecmp_drstatic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdrstatecmp_drstatic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drstatecmp_drstatic )
list(APPEND _IMPORT_CHECK_FILES_FOR_drstatecmp_drstatic "${_IMPORT_PREFIX}/ext/lib32/release/libdrstatecmp_drstatic.a" )
...
# Import target "drcallstack_drstatic" for configuration "RelWithDebInfo"
set_property(TARGET drcallstack_drstatic APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(drcallstack_drstatic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/ext/lib32/release/libdrcallstack_drstatic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drcallstack_drstatic )
list(APPEND _IMPORT_CHECK_FILES_FOR_drcallstack_drstatic "${_IMPORT_PREFIX}/ext/lib32/release/libdrcallstack_drstatic.a" )
